...
static const char *aidianjiaUIControl_acceptEventInterval = "aidianjiaUIControl_acceptEventInterval";
static const char *aidianjiaUIControl_acceptEventTime = "aidianjiaiOSUIControl_acceptEventTime";
...
- (NSTimeInterval)yt_acceptEventInterval {
    return [objc_getAssociatedObject(self, aidianjiaUIControl_acceptEventInterval) doubleValue];
}

- (void)setYt_acceptEventInterval:(NSTimeInterval)yt_acceptEventInterval {
    objc_setAssociatedObject(self, &aidianjiaUIControl_acceptEventInterval, @(yt_acceptEventInterval), OBJC_ASSOCIATION_ASSIGN);
}

- (NSTimeInterval)yt_acceptEventTime {
    return [objc_getAssociatedObject(self, aidianjiaUIControl_acceptEventTime) doubleValue];
}

- (void)setYt_acceptEventTime:(NSTimeInterval)yt_acceptEventTime {
    objc_setAssociatedObject(self, &aidianjiaUIControl_acceptEventTime, @(yt_acceptEventTime), OBJC_ASSOCIATION_ASSIGN);
}
